...
Current application release: `2.7.0`. The repository-root `VERSION` file is canonical; `/api/public-status` and the UI receive the value from the running backend.
