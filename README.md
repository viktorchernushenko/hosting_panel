...
MyH is a production-oriented, multi-user Flask hosting platform. Current release: **2.10.0**. The canonical version is stored in [`VERSION`](VERSION).
...
- Backend-driven runtime registry and lifecycle-tested Static, PHP 8.2, managed WordPress on PHP 8.3, Node.js 22, Python 3.12 and validated Dockerfile hosting.
...
See [WORDPRESS.md](WORDPRESS.md), [RUNTIMES.md](RUNTIMES.md), [ARCHITECTURE.md](ARCHITECTURE.md), [SECURITY.md](SECURITY.md), [DATABASES.md](DATABASES.md), [SFTP.md](SFTP.md), [BACKUP_RESTORE.md](BACKUP_RESTORE.md) and [OPERATIONS.md](OPERATIONS.md).
